<template>
  <div class="msiteContainer"  @click="scrollHeader">
    ...
    <div class="ceilItems">
      ...
      <div class="ceilImg">
        <a href="javascript">
          <img src="./images/content/ceilhot.jpg" alt />
        </a>
      </div>
      <div class="hotItems">
        <ul class="hotItem">
    ...
    <div class="service">
      ...
      <div class="servicemessage">
        ...
        <div class="serviceinfo">
          <p class="servicetitle">在线客服</p>
          <p class="message">全年无休</p>
        </div>
      </div>
      <div class="servicephone">
        <img src="./images/phone.png" alt="">
        <div class="serviceinfo">
          <p class="servicetitle">客服热线400-7---6600</p>
          <p class="message">周一至周日，全年无休</p>
        </div>
      </div>
    </div>
    <div class="bottom">
